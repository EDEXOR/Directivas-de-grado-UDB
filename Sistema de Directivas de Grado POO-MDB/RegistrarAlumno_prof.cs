...
{
    public partial class RegistrarAlumno_prof : Form
    {
        public RegistrarAlumno_prof(String id)
        {
            InitializeComponent();
            user.Text = id;
            user.Visible = false;
        ...
        private void BtnAceptar_Click(object sender, EventArgs e)
        {
                ...
                MessageBox.Show("Se agrego con exito", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
